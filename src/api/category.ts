import {Tag, CategoryListPagingRequest, CategoryListResponse, CreateCategory} from "@/types/dashboard/category";
...
export const getCategoryBySlugApi = async (request: string): Promise<Tag> => {
...
export const createCategoryApi = async (createCategory: CreateCategory): Promise<Tag> => {
    return await apiPost("categories", createCategory);
};

export const updateCategoryApi = async (id: string, updateCategory: CreateCategory): Promise<Tag> => {
